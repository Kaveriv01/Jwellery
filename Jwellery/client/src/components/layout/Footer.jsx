...
function FooterLink({ to, children }) {
  return (
    <Link
      to={to}
      className="text-[14px] text-[#22181C] font-[500] uppercase tracking-[0.10em] hover:text-[#22181C] transition-colors"
    ...
    <div className="bg-[#FDFBF7]">
      ...
      <div className="border-t border-[#EAE6DF] mt-8 lg:mt-0">
        <div className="container-luxury pt-20 pb-20 lg:py-24 flex flex-col items-center text-center">
          ...
          <p className="text-[14px] text-[#22181C] font-[400] max-w-md mb-8" style={{ fontFamily: "'Nunito Sans', sans-serif" }}>
            Discover new collections, thoughtful designs and stories from TARINI JEWELLERS.
          </p>
          <form className="flex w-full max-w-md border-b border-[#22181C] pb-2 group relative overflow-visible" onSubmit={(e) => e.preventDefault()}>
            <input 
              type="email" 
              placeholder="Your email address" 
              className="flex-1 bg-transparent border-none outline-none text-[14px] text-[#22181C] placeholder:text-[#22181C] font-[400]" 
              style={{ fontFamily: "'Nunito Sans', sans-serif" }}
              required 
            />
            <button 
              type="submit" 
              className="text-[13px] text-[#22181C] font-[600] uppercase tracking-[0.08em] hover:text-[#C5A059] transition-colors pl-4"
              style={{ fontFamily: "'Nunito Sans', sans-serif" }}
            >
              Subscribe
            </button>
      ...
      {/* ── MAIN FOOTER ───────────────────────────────────────────────────── */}
      <footer className="pt-20 pb-10 bg-[#FDFBF7] text-[#22181C] border-t border-[#EAE6DF]">
        <div className="container-luxury max-w-[1400px]">
          ...
          <div className="text-center mb-20 flex flex-col items-center">
            ...
            <div className="flex justify-center gap-6 text-[#22181C]">
              <motion.a whileHover={{ scale: 1.15, color: '#22181C' }} href="#" className="transition-colors duration-300 p-2"><FiInstagram size={20} strokeWidth={1.5} /></motion.a>
              <motion.a whileHover={{ scale: 1.15, color: '#22181C' }} href="#" className="transition-colors duration-300 p-2"><FiFacebook size={20} strokeWidth={1.5} /></motion.a>
              <motion.a whileHover={{ scale: 1.15, color: '#22181C' }} href="#" className="transition-colors duration-300 p-2"><FaPinterestP size={20} /></motion.a>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-16 text-left mb-20 px-2 sm:px-0">
            ...
            <div>
              <h4 className="text-[13px] font-[700] uppercase tracking-[0.08em] text-[#22181C] mb-6" style={{ fontFamily: "'Nunito Sans', sans-serif" }}>ABOUT</h4>
              <ul className="space-y-4">
            ...
            <div>
              <h4 className="text-[13px] font-[700] uppercase tracking-[0.08em] text-[#22181C] mb-6" style={{ fontFamily: "'Nunito Sans', sans-serif" }}>HELP</h4>
              <ul className="space-y-4">
            ...
            <div>
              <h4 className="text-[13px] font-[700] uppercase tracking-[0.08em] text-[#22181C] mb-6" style={{ fontFamily: "'Nunito Sans', sans-serif" }}>LEGAL</h4>
              <ul className="space-y-4">
          ...
          <div className="text-center pt-8">
            <p className="text-[11px] lg:text-[12px] tracking-[0.10em] uppercase text-[#22181C] font-[500]" style={{ fontFamily: "'Nunito Sans', sans-serif" }}>
