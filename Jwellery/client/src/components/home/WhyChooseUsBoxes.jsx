      ...
      <div className="container mx-auto px-4 text-center">
        ...
        >
          ...
          <motion.h2 
            ...
            className="text-3xl lg:text-4xl text-[#22181C] mb-16 font-normal" style={{ fontFamily: "'Cormorant Garamond', serif" }}>Why Choose Tarini</motion.h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 max-w-6xl mx-auto">
          {reasons.map((reason, idx) => (
            ...
            >
              <h3 className="text-[#22181C] text-xl font-normal mb-3" style={{ fontFamily: "'Cormorant Garamond', serif" }}>{reason.title}</h3>
              <p className="text-[11px] text-[#22181C] leading-relaxed uppercase tracking-[0.1em]" style={{ fontFamily: "'Nunito Sans', sans-serif" }}>{reason.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
