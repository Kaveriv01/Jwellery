        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {features.map((feature, idx) => (
            <div key={idx} className="flex flex-col items-center justify-center gap-3 p-4 group cursor-pointer hover:scale-105 transition-transform duration-300">
              <feature.icon size={28} className="text-[#E8E1D6] group-hover:text-[#C5A059] transition-colors duration-300 mb-1" />
              <span className="text-[14px] md:text-[18px] font-bold tracking-wide text-[#333] group-hover:text-[#E8E1D6] transition-colors duration-300" style={{ fontFamily: "'Nunito Sans', sans-serif" }}>
                {feature.text}
              </span>
            </div>
          ))}
