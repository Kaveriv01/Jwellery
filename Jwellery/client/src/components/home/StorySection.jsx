...
export default function StorySection() {
  ...
  return (
    <section className="py-24 lg:py-32 bg-[#F7F3EA]/30 overflow-hidden">
      <div className="container-luxury">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <motion.div
            ...
            className="relative h-[400px] lg:h-[600px] overflow-hidden bg-[#FAF6EE] rounded-[3px] border border-[#FAF6EE]"
          >
            <img
            ...
            />
            <div className="absolute inset-0 border-[16px] border-white/15 mix-blend-overlay" />
          </motion.div>
          ...
          >
            ...
            <h2 className="text-[#3A0508] text-[22px] md:text-[26px] lg:text-[32px] leading-tight font-normal mb-[16px]" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              Jewellery should not simply complete an outfit.<br />It should become part of the moments you remember.
            </h2>
            
            <p className="text-[#756B62] text-[13px] lg:text-[14px] leading-relaxed mb-8 max-w-lg font-light">
