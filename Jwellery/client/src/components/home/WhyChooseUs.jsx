...
export default function WhyChooseUs() {
  ...
  return (
    <section className="bg-[#1A1512] py-12 border-b border-[#DED3C4] overflow-hidden">
          ...
          {values.map((val, idx) => (
            <motion.div key={idx} variants={itemVariants} className="group relative flex items-center justify-center gap-4 py-6 lg:py-0 px-4">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-[12px] text-[#8A8177] font-normal" style={{ fontFamily: "'Nunito Sans', sans-serif" }}>
                  {val.description}
                </p>
              </div>
            </motion.div>
