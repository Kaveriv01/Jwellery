    ...
    <>
      ...
      <div className="space-y-6 max-w-4xl">
        ...
        <div>
          ...
          <p className="text-sm text-[#756A63] mt-1">Modify and update specifications of "{product?.name}"</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-[#DED3C4] space-y-4">
            ...
            {existingImages.length > 0 && (
              <div>
                <p className="text-xs font-semibold text-[#756A63] mb-2">Existing Images</p>
                <div className="grid grid-cols-2 sm:grid-cols-5 gap-3 mb-4">
                  {existingImages.map((img) => (
                    <div key={img._id} className="relative aspect-square rounded-xl overflow-hidden border border-[#DED3C4] group">
            ...
            {/* New Images */}
            <div>
              <p className="text-xs font-semibold text-[#756A63] mb-2">Upload New Images</p>
