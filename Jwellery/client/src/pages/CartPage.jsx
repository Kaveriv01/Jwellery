...
function CartItem({ item, onUpdate, onRemove }) {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex gap-4 bg-[#FDFBF7]/10 border border-[#FDFBF7] rounded-[2px] p-4 transition-all duration-[250ms]">
      <Link to={`/products/${product.slug}`} className="flex-shrink-0 bg-[#FDFBF7] p-2 border border-[#FDFBF7] rounded-[2px] w-20 h-20 sm:w-24 sm:h-24">
