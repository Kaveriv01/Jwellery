    ...
    <>
      ...
      <div className="container-luxury py-20 max-w-4xl">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <img src="https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=600" alt="About Tarini Jewellers" className="rounded-[2px] w-full aspect-square object-cover border border-[#FAF6EE]" />
        </div>
